...
const MovieDetailPage = () => {
  ...
  const displayedCast = showAllCast ? movie.cast : movie.cast.slice(0, 4);
  ...
  return (
    <div className="min-h-screen bg-[#1B1A1A] text-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <Image src={movie.image} alt={movie.title} fill className="object-cover blur-3xl opacity-20" priority />
      </div>
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 md:py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-12">
            ...
            <div className="flex-1">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed text-base md:text-lg">{movie.description}</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            {/* MPA Rating */}
            <div>
              <h3 className="text-xl font-semibold mb-4">MPA Rating</h3>
              <p className="text-gray-300 text-lg">{movie.rating}</p>
            </div>

            {/* Box Office Gross */}
            <div>
              <h3 className="text-xl font-semibold mb-4">Box Office Gross</h3>
              <p className="text-gray-300 text-lg">{movie.boxOffice}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-[#2A2929] rounded-lg shadow-2xl max-w-md w-full p-6 border border-red-500/30">
            ...
            <p className="text-gray-300 mb-6">
              Are you sure you want to delete <span className="font-semibold text-white">&quot;{movie.title}&quot;</span>? This action cannot be undone.
            </p>
